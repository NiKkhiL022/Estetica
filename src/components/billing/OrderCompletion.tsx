          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 lg:sticky lg:top-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between text-sm sm:text-base">
                ...
                <span className="font-medium">{billing.orderDiscount}</span>
              </div>

              <div className="flex justify-between text-sm sm:text-base">
                <span className="text-gray-600">Tax ({billing.taxRate}%)</span>
                <span className="font-medium">
                  ₹{((billing.productTotal * billing.taxRate) / 100).toFixed(2)}
                </span>
              </div>
            ...
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg font-medium mt-6 transition-colors duration-200">
              <span className="text-sm sm:text-base">✨ Complete Payment</span>
            </button>
          </div>
        </div>
      </div>
